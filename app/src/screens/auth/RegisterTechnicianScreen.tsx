...
export function RegisterTechnicianScreen() {
  ...
  const handleSubmit = async () => {
    try {
      ...
      if (!fullName || !email || !phone || !password || !confirmPassword) {
        setError(t("registerTechnicianScreen.requiredFieldsError"));
        return;
      }

      if (password !== confirmPassword) {
        setError(t("registerTechnicianScreen.passwordMismatchError"));
        return;
      }
      ...
      const response = await UserService.registerTecnico(payload);

      setSuccessData({
        title: t("registerTechnicianScreen.successTitle"),
      ...
      const message =
        ...
        t("registerTechnicianScreen.createAccountError");
    ...
    >
      ...
      >
        ...
        <AppHeader
          ...
          title={t("registerTechnicianScreen.headerTitle")}
          subtitle={t("registerTechnicianScreen.headerSubtitle")}
          onBack={() => {
            if(isRegisteringSocial){
              return;
            }
        ...
        <ScrollView contentContainerStyle={styles.content}>
          ...
          <View style={styles.section}>
            <TextInput
              ...
              placeholder={t("registerTechnicianScreen.fullNamePlaceholder")}
          ...
          <View style={styles.section}>
            <TextInput
              ...
              placeholder={t("registerTechnicianScreen.nicknamePlaceholder")}
              placeholderTextColor={colors.textMuted}
            />
          </View>
          ...
          <View style={styles.section}>
            <TextInput
              ...
              autoCapitalize="none"
              placeholder={t("registerTechnicianScreen.emailPlaceholder")}
              placeholderTextColor={colors.textMuted}
            />
          </View>
          ...
          <View style={styles.section}>
            <Text style={styles.label}>
              {t("registerTechnicianScreen.whatsappLabel")} *
            </Text>
          ...
          <View style={styles.section}>
            <Text style={styles.label}>
              {t("registerTechnicianScreen.createPasswordLabel")}
            </Text>
            ...
            <View style={styles.passwordBox}>
              <TextInput
                ...
                placeholder={t("registerTechnicianScreen.passwordPlaceholder")}
                placeholderTextColor={colors.textMuted}
                autoCapitalize="none"
              />
          ...
          <View style={styles.section}>
            <View style={styles.passwordBox}>
              <TextInput
                ...
                placeholder={t(
                  "registerTechnicianScreen.confirmPasswordPlaceholder",
                )}
                placeholderTextColor={colors.textMuted}
                autoCapitalize="none"
              />
          ...
          <View style={styles.actionsContainer}>
              ...
              {loading ? (
                <View style={styles.loadingRow}>
                  ...
                  <Text style={styles.buttonText}>
                    {t("registerTechnicianScreen.creating")}
                  </Text>
                </View>
              ) : (
                <Text style={styles.buttonText}>
                  {t("registerTechnicianScreen.createAccount")}
                </Text>
              )}
            </Pressable>
            ...
            <Text style={styles.termsText}>
              {t("registerTechnicianScreen.termsPrefix")}
              <Text style={styles.termsLink}>
                {t("registerTechnicianScreen.termsOfUse")}
              </Text>
              {t("registerTechnicianScreen.termsAnd")}
              <Text style={styles.termsLink}>
                {t("registerTechnicianScreen.privacyPolicy")}
              </Text>
            </Text>
          </View>
        </ScrollView>
        ...
        <ConfirmModal
          ...
          variant="single"
          confirmText={t("registerTechnicianScreen.goToLogin")}
