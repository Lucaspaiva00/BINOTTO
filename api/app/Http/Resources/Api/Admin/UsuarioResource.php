...
class UsuarioResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'phoneOwner' => $this->telefone_titular,
            ...
            'secondaryPhoneOwner' => $perfil?->telefone_secundario_titular,
            'secondaryEmail' => $this->perfil === 'OFICINA' ? $this->oficina?->email_secundario : null,
            'tradeName' => match ($this->perfil) {
                'OFICINA' => $this->oficina?->nome_fantasia,
                'TECNICO' => $this->tecnico?->nome_fantasia_empresa,
                default => null,
            },
            'companyName' => match ($this->perfil) {
                'OFICINA' => $this->oficina?->razao_social,
                'TECNICO' => $this->tecnico?->razao_social_empresa,
                default => null,
            },
            'companyDocument' => match ($this->perfil) {
                'OFICINA' => $this->oficina?->cnpj,
                'TECNICO' => $this->tecnico?->cnpj,
                default => null,
            },
            ...
            'languages' => $this->perfil === 'TECNICO' ? ($this->tecnico?->idiomas ?? []) : [],
            'bankName' => $this->perfil === 'TECNICO' ? $this->tecnico?->banco_nome : null,
            'bankIban' => $this->perfil === 'TECNICO' ? $this->tecnico?->banco_iban : null,
            'bankSwift' => $this->perfil === 'TECNICO' ? $this->tecnico?->banco_swift : null,
            'bankAddress' => $this->perfil === 'TECNICO' ? $this->tecnico?->banco_endereco : null,
