    ...
    <>
      ...
      <View style={styles.card}>
        <View style={styles.inputWrapper}>
          <TextInput
            autoCapitalize="none"
            placeholder={t("technicianSettingsScreen.password.currentPassword")}
        ...
        <Pressable onPress={onForgotPassword}>
          <Text style={styles.link}>
            {t("technicianSettingsScreen.password.forgotPassword")}
          </Text>
        </Pressable>
        ...
        <View style={styles.inputWrapper}>
          <TextInput
            autoCapitalize="none"
            placeholder={t("technicianSettingsScreen.password.newPassword")}
            placeholderTextColor={colors.textMuted}
        ...
        <View style={styles.inputWrapper}>
          <TextInput
            autoCapitalize="none"
            placeholder={t("technicianSettingsScreen.password.confirmPassword")}
            placeholderTextColor={colors.textMuted}
        ...
        >
          <Text style={styles.buttonText}>
            {changingLoading
              ? t("technicianSettingsScreen.password.saving")
              : t("technicianSettingsScreen.password.save")}
          </Text>
        </Pressable>
      </View>
    </>
